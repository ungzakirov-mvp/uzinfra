...
export function SectionHeader({
  ...
  return (
    ...
    >
      ...
      <h2 className="text-balance text-4xl font-semibold leading-[1.05] text-[#17221c] sm:text-5xl lg:text-6xl">
        {title}
      </h2>
      {copy ? (
        <p
          className={`mt-6 max-w-2xl text-base leading-8 text-[#65736b] sm:text-lg ${centered ? "mx-auto" : ""}`}
        >
          {copy}
        </p>
      ) : null}
